      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        ...
        <section className="mb-14">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              { title: "Surety Bond for Government Projects in Batam", href: "/en/blog/surety-bond-government-projects-batam", desc: "Complete guide to all surety bond types and submission procedures" },
