              ...
              <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                {[
                  ...
                  <div key={f.label}>
                    ...
                    <input type={f.type} placeholder={f.placeholder} className="w-full px-4 py-3 rounded-xl border-2 border-[#e2e8f0] focus:border-[#1a4fa0] outline-none text-sm transition-colors" />
                  </div>
                ))}
                <div>
                ...
                <div>
                  ...
                  <textarea rows={4} placeholder="Ceritakan kebutuhan asuransi Anda..." className="w-full px-4 py-3 rounded-xl border-2 border-[#e2e8f0] focus:border-[#1a4fa0] outline-none text-sm transition-colors resize-none" />
                </div>
                <a
