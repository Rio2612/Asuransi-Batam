...
const schema = { "@context": "https://schema.org", "@type": "Service", name: "Asuransi Alat Berat Batam", provider: { "@type": "InsuranceAgency", name: "Asuransi Batam – Rio", telephone: "+6281373336728" } };
